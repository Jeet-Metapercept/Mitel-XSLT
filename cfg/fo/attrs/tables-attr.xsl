...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0">
  ...
  <xsl:attribute-set name="common.table.head.entry">
    <xsl:attribute name="font-weight"><!-- bold -->normal</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="__tableframe__left" use-attribute-sets="table.border__left">
  </xsl:attribute-set>

  <xsl:attribute-set name="__tableframe__right" use-attribute-sets="table.border__right">
  </xsl:attribute-set>
  <!--end-->
  ...
  <!--For custom tables-->
  <xsl:attribute-set name="table__tableframe__top" use-attribute-sets="table.border__top">
  </xsl:attribute-set>
 ...
 <!--  <xsl:attribute-set name="table__tableframe__right" use-attribute-sets="common.border__right">
  ...
  <!--For custom table-->
   <xsl:attribute-set name="table__tableframe__right" use-attribute-sets="table.border__right">
  </xsl:attribute-set>

  <xsl:attribute-set name="table__tableframe__left" use-attribute-sets="table.border__left">
  </xsl:attribute-set>
  <!--end-->
  ...
  <xsl:attribute-set name="sthead">
		<xsl:attribute name="color">#01A0E1</xsl:attribute>
