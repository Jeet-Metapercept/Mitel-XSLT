...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="pagenum">
    ...
    <xsl:attribute-set name="__body__odd__footer" use-attribute-sets="odd__footer">
			 <xsl:attribute name="font-weight">bold</xsl:attribute>
			 <xsl:attribute name="end-indent">30mm</xsl:attribute><!-- value of side-col-width = 30mm -->
    ...
    <xsl:attribute-set name="__body__even__footer" use-attribute-sets="even__footer">
			...
			<xsl:attribute name="start-indent">30mm</xsl:attribute><!-- value of side-col-width = 30mm -->
		    <xsl:attribute name="padding-bottom">10mm</xsl:attribute>
    </xsl:attribute-set>
	...
	<!--body custom headers-->
	<xsl:attribute-set name="__body__even__header_label_container">
			<xsl:attribute name="border-bottom">solid black 0.5pt</xsl:attribute>
			<xsl:attribute name="width">156mm</xsl:attribute>
					<xsl:attribute name="start-indent">30mm</xsl:attribute>
					<!-- <xsl:attribute name="top">-10mm</xsl:attribute> -->
    </xsl:attribute-set>
	
	<xsl:attribute-set name="__body__even__header_label">
			<xsl:attribute name="text-align">start</xsl:attribute>
			<xsl:attribute name="font-size">10pt</xsl:attribute>
			<xsl:attribute name="font-weight">bold</xsl:attribute>
					<!-- <xsl:attribute name="border">solid red 1pt</xsl:attribute> -->
					<xsl:attribute name="start-indent">0mm</xsl:attribute> <!-- OMG! -->
							<xsl:attribute name="space-before">15mm</xsl:attribute>
							<xsl:attribute name="padding-bottom">1mm</xsl:attribute>
    </xsl:attribute-set>
	
	<xsl:attribute-set name="__body__odd__header_label_container">
			<xsl:attribute name="border-bottom">solid black 0.5pt</xsl:attribute>
			<xsl:attribute name="width">156mm</xsl:attribute>
					<xsl:attribute name="start-indent">30mm</xsl:attribute>
					<!-- <xsl:attribute name="top">-10mm</xsl:attribute> -->
	...
	<xsl:attribute-set name="__body__odd__header_label">
			<xsl:attribute name="text-align">end</xsl:attribute>
			<xsl:attribute name="font-size">10pt</xsl:attribute>
			<xsl:attribute name="font-weight">bold</xsl:attribute>
					<!-- <xsl:attribute name="border">solid red 1pt</xsl:attribute> -->
	...
	<!--toc custom headers-->
	<xsl:attribute-set name="__toc__odd__header_label_container">
			<xsl:attribute name="border-bottom">solid black 0.5pt</xsl:attribute>
			<xsl:attribute name="width">156mm</xsl:attribute>
					<xsl:attribute name="start-indent">30mm</xsl:attribute>
    </xsl:attribute-set>
	
	<xsl:attribute-set name="__toc__odd__header_label">
			<xsl:attribute name="text-align">start</xsl:attribute>
			<xsl:attribute name="font-size">10pt</xsl:attribute>
			<xsl:attribute name="font-weight">bold</xsl:attribute>
					<!-- <xsl:attribute name="border">solid red 1pt</xsl:attribute> -->
	...
	<xsl:attribute-set name="__toc__even__header_label_container">
			<xsl:attribute name="border-bottom">solid black 0.5pt</xsl:attribute>
			<xsl:attribute name="width">156mm</xsl:attribute>
					<xsl:attribute name="start-indent">30mm</xsl:attribute>
    </xsl:attribute-set>
	
	<xsl:attribute-set name="__toc__even__header_label">
			<xsl:attribute name="text-align">end</xsl:attribute>
			<xsl:attribute name="font-size">10pt</xsl:attribute>
			<xsl:attribute name="font-weight">bold</xsl:attribute>
					<!-- <xsl:attribute name="border">solid red 1pt</xsl:attribute> -->
