...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:attribute-set name="__toc__header" use-attribute-sets="common.title">
        ...
        <!-- <xsl:attribute name="space-after">16.8pt</xsl:attribute> -->
				<xsl:attribute name="space-after">4.2pt</xsl:attribute>
    ...
    <xsl:attribute-set name="__toc__chapter__content" use-attribute-sets="__toc__topic__content">
        <xsl:attribute name="font-size"><!-- 14pt -->10pt</xsl:attribute>
        <xsl:attribute name="font-weight"><!-- bold -->normal</xsl:attribute>
        <xsl:attribute name="padding-top"><!-- 20pt -->10pt</xsl:attribute>
    </xsl:attribute-set>
