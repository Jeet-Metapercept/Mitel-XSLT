...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- For Tables -->
  <xsl:attribute-set name="table.border__top">
  ...
  <xsl:attribute-set name="table.border__right">
    <xsl:attribute name="border-right-style">hidden</xsl:attribute>
    <xsl:attribute name="border-right-width">1pt</xsl:attribute>
    <xsl:attribute name="border-right-color">black</xsl:attribute>
  </xsl:attribute-set>

  <xsl:attribute-set name="table.border__left">
  ...
  <!-- common element specific attribute sets -->
    ...
    <xsl:attribute-set name="topic.topic.topic.title" use-attribute-sets="common.title">
        ...
        <!-- <xsl:attribute name="font-weight">bold</xsl:attribute> -->
        <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute>
				<xsl:attribute name="color">#404041</xsl:attribute>
        ...
        <xsl:attribute name="force-page-count">
            <xsl:choose>
                <xsl:when test="name(/*) = 'bookmap'">
                    <!-- <xsl:value-of select="'even'"/> --><xsl:value-of select="'auto'"/>
                </xsl:when>
                <xsl:otherwise>
