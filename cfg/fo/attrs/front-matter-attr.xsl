...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Logo image-->
	<xsl:attribute-set name="__LogoImage">
        <xsl:attribute name="position">absolute</xsl:attribute>
        <xsl:attribute name="top">120mm</xsl:attribute>
	...
	<!--book id-->
	<xsl:attribute-set name="__frontmatter__bookid" use-attribute-sets="common.title">
						<xsl:attribute name="color">#57B6CC</xsl:attribute>
						<xsl:attribute name="space-before">3mm</xsl:attribute>
				<xsl:attribute name="font-size">14pt</xsl:attribute>
				<!-- <xsl:attribute name="font-weight">bold</xsl:attribute> -->
				<!-- <xsl:attribute name="text-align">right</xsl:attribute>
				<xsl:attribute name="margin-right">25mm</xsl:attribute>
						<xsl:attribute name="font-family">FontWaikato</xsl:attribute> -->
    ...
    <xsl:attribute-set name="__frontmatter__title" use-attribute-sets="common.title">
        <xsl:attribute name="space-before">80mm+80mm</xsl:attribute>
        <xsl:attribute name="space-before.conditionality">retain</xsl:attribute>
        <xsl:attribute name="font-size">30pt</xsl:attribute>
        <!-- <xsl:attribute name="font-weight">bold</xsl:attribute> -->
        <xsl:attribute name="line-height">140%</xsl:attribute>
				<xsl:attribute name="color">#0D294D</xsl:attribute>
    </xsl:attribute-set>
