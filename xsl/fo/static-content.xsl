...
<!--        <xsl:call-template name="insertPrefaceLastFooter"/>-->
    ...
    <xsl:template name="insertBodyOddHeader">
        ...
        <fo:static-content flow-name="odd-body-header">
			...
			<!--body topic titles on header-->
								<fo:block-container xsl:use-attribute-sets="__body__odd__header_label_container">
									<fo:block xsl:use-attribute-sets="__body__odd__header_label">
										 <fo:retrieve-marker retrieve-class-name="current-header"/>
									</fo:block>
								</fo:block-container>
							<!--end-->
    ...
    <xsl:template name="insertBodyEvenHeader">
        ...
        <fo:static-content flow-name="even-body-header">
            <fo:block xsl:use-attribute-sets="__body__even__header">
				...
				<!--bookmap name on header-->
								<fo:block-container xsl:use-attribute-sets="__body__even__header_label_container">
									<fo:block xsl:use-attribute-sets="__body__even__header_label">
										<xsl:choose>
    ...
    <xsl:template name="insertTocOddHeader">
        <fo:static-content flow-name="odd-toc-header">
            <fo:block xsl:use-attribute-sets="__toc__odd__header">
				...
				<!--bookmap name on header-->
								<fo:block-container xsl:use-attribute-sets="__toc__odd__header_label_container">
									<fo:block xsl:use-attribute-sets="__toc__odd__header_label">
										<xsl:choose>
											<xsl:when test="$map/*[contains(@class,' topic/title ')][1]">
												<xsl:apply-templates select="$map/*[contains(@class,' topic/title ')][1]"/>
											</xsl:when>
    ...
    <xsl:template name="insertTocEvenHeader">
        <fo:static-content flow-name="even-toc-header">
			...
			<!--Table of Contents on header-->
								<fo:block-container xsl:use-attribute-sets="__toc__even__header_label_container">
									<fo:block xsl:use-attribute-sets="__toc__even__header_label">
