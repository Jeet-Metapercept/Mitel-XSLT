    ...
    <xsl:template name="createFrontMatter_1.0">
        <fo:page-sequence master-reference="front-matter" xsl:use-attribute-sets="__force__page__count">
            ...
            <fo:flow flow-name="xsl-region-body">
				...
				<!-- logo image -->
                    <fo:block-container xsl:use-attribute-sets="__LogoImage">
                        <fo:block>
                            <fo:external-graphic src="url(Customization/OpenTopic/common/artwork/logo_mitel.svg)" tooltip="Mitel"/>
                        </fo:block>                      
                    </fo:block-container>
                    <!--/-->
					...
					<!--book part number information-->
                   	<fo:block xsl:use-attribute-sets="__frontmatter__bookid">
						<!-- <xsl:if test="$map//bookmeta/bookid/bookpartno"> -->
